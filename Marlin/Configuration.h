...
#define STRING_CONFIG_H_AUTHOR "(klc, kossel mini)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Slash"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "8de153bd-063e-4794-8a62-e592bca97d8d"
...
#define HOTEND_OFFSET_X { 0.0, -9.00 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, 15.59 }  // (mm) relative Y-offset for each nozzle
...
#define DELTA
  ...
  #define DELTA_HEIGHT 234.0             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 101.36              // (mm) Get this value from G33 auto calibrate
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0.6, -21.2, -1.8 }
